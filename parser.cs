...
namespace com.calitha.goldparser
{
    ...
    enum RuleConstants : int
    {
        ...
        RULE_TERM_TIMES                                         = 11, // <term> ::= <term> '*' <f>
        RULE_TERM_DIV                                           = 12, // <term> ::= <term> '/' <f>
        RULE_TERM_PERCENT                                       = 13, // <term> ::= <term> '%' <f>
        RULE_TERM                                               = 14, // <term> ::= <f>
        RULE_F_TIMESTIMES                                       = 15, // <f> ::= <f> '**' <exp>
        RULE_F                                                  = 16, // <f> ::= <exp>
        ...
        RULE_IF_STAT_IF_LPAREN_RPAREN_START_END_ELSE            = 22, // <if_stat> ::= if '(' <cond> ')' Start <stat_list> End else <stat_list>
    ...
    public class MyParser
    {
        ...
        public Object CreateObjectFromNonterminal(NonterminalToken token)
        {
            switch (token.Rule.Id)
            {
                ...
                case (int)RuleConstants.RULE_DATA_FLOUT :
                //<data> ::= flout
                //todo: Create a new object using the stored tokens.
                return null;
